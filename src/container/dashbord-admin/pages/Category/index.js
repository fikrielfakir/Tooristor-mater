    ...
    return (
        <div className="content fs-6 d-flex flex-column flex-column-fluid">
            <div className="toolbar">
                ...
                <div className="d-flex align-items-start flex-wrap me-2 headAdd"><div className="text-dark fw-bolder my-1 fs-2">Category</div><Link to="/admin/category/add"><button className="addNew" >Add new</button></Link></div>
