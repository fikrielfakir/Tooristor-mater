    ...
    <div>
      <div className="CinputSetting Create">
        ...
        <form className="inputSetting" onSubmit={handleUpdateProduct}>
          ...
          <div className="inlIne"><h5>Parent</h5>    <Toggle checked={content} onChange={setContent} /></div>
          ...
          <div className="validationbutton"><button className="sumbit send" type="submit">Send</button><button onClick={props.onClick} className="sumbit cancel" type="Cancel">Cancel</button></div>
        </form>
        )}
      </div>
      {/* Spreadsheet Labels */}
